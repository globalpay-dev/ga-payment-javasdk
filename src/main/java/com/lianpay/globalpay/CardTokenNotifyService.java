...
public class CardTokenNotifyService extends BaseService {

    public CardTokenNotifyRequest checkNotifySignAndGetPaymentsNotifyRequest(Map<String, String> headers,
                                                                            String requestJsonBody, MerchantPropertyReader merchantPropertyReader) throws ParamCheckFailException, VerifySignFailException {
        checkNotifyRequestWithException(merchantPropertyReader);
        checkNotifySign(headers, requestJsonBody, merchantPropertyReader);
        return JacksonUtils.parseObject(requestJsonBody, CardTokenNotifyRequest.class);
    }
