...
public class MerchantUnbindTokenService extends BaseService{


    public ApiResult<?> sendUnbindCardTokenRequest(CardTokenRequest cardTokenRequest, MerchantPropertyReader merchantPropertyReader)
    ...
    public ImmutablePair<Map<String,String>, CardTokenRequest> getCardTokenHeadersAndRequest(CardTokenRequest cardTokenRequest, MerchantPropertyReader merchantPropertyReader) throws SignException {
        return doGetPaymentHeadersAndRequest(cardTokenRequest, merchantPropertyReader);
    }

    private ImmutablePair<Map<String,String>, CardTokenRequest> doGetPaymentHeadersAndRequest(CardTokenRequest cardTokenRequest, MerchantPropertyReader merchantPropertyReader) throws SignException {
    ...
    public ApiResult<?> doSendPaymentRequest(Map<String,String> headers, CardTokenRequest cardTokenRequest,
        ...
        HttpClient.HttpClientResponse httpClientResponse = DefaultHttpClient.httpClientHolder.postJsonRequestNew(
                ISOUtil.getUnbindTokenUrl(merchantPropertyReader), JacksonUtils.toJsonString(cardTokenRequest), headers, merchantPropertyReader.openDebuggerLog());
